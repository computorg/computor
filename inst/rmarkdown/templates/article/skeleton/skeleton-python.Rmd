...
The R package [reticulate](https://cran.r-project.org/package=reticulate) package [@R-reticulate] includes a Python engine for R Markdown that enables easy interoperability between Python and R chunks.
