...
This document provides a basic Rmarkdown^[rmarkdown.rstudio.com] template for contributions to the **Computo** Journal, possibly including R code. Other templates are provided for contributions including python and Julia code:
